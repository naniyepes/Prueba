...
public class AplicationContextListenerUdeA implements ServletContextListener {
	...
	try {
			...
			JobDetail jobDetail = new JobDetailImpl("Job", Scheduler.DEFAULT_GROUP, JobAlertasActividadesDocentesSinRegistrar.class);
			...
			//Trigger trigger = new SimpleTriggerImpl("HolaMundoTrigger", Scheduler.DEFAULT_GROUP, 1, 5000);
		 	...
		 	CronTrigger trigger = new CronTriggerImpl("Trigger", Scheduler.DEFAULT_GROUP, "0 0 12 15 1/1 ? *");
